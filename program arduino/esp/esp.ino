...
void loop()
{
  ...
  //butonul verde -> inceperea secventei de verificare
...
void wifi_reinit(){
  establishConnection("AT+CWJAP=\"Test\",\"87654321\"", 7000); //provide your WiFi username and password here
...
void wifi_init() //send AT commands to module
{
  ...
  if (!No_IP)
  {
    ...
    establishConnection("AT+CWJAP=\"Test\",\"87654321\"", 7000); //provide your WiFi username and password herehere
  }
  else
  {
  }
